...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        questions_data = [
            {
                'question_text': 'What is the most challenging part of Software Engineering assignments?',
        ...
        self.stdout.write(
            self.style.SUCCESS(f'✅ Created {len(questions_data)} questions with choices!')
        )
